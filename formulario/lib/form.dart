  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final response = await http.post(
        Uri.parse(
            'https://responsiveuvg-1653f-default-rtdb.firebaseio.com/estudiantes.json'), // Reemplaza con tu URL de la API
      ...
      if (response.statusCode == 200) {
        ...
        // Si hubo un error
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Error al crear el estudiante')));
      }
    }
  }
